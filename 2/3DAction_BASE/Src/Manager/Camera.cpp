...
void Camera::ProcessRot(void)
{
	...
	{
		mAngles.y = AsoUtility::RadIn2PI(mAngles.y - AsoUtility::Deg2RadF(CAMERA_ANGLE_SPEED_Y));
	}
	...
	{
		mAngles.x = (mAngles.x - AsoUtility::Deg2RadF(CAMERA_ANGLE_SPEED_X));

		mAngles.x = AsoUtility::Deg2RadF(std::clamp(AsoUtility::Rad2DegF(mAngles.x), -LIMIT_X_DW_DEG, LIMIT_X_UP_DEG));
	}
